...
- alpha: no influence on optimal strategy as long as alpha is constant for t
- mb: just determine the scale of mx and my; mx/mb and my/mb have influences.
- uave: just determine the scale of v; relative speed (v/uave) has influence.
- C: ust determine the scale of lmax, lmin (althought smaller lmax&lmin also reduce the relative influence of 'my'). lmax and lmin define the predation efficiency.
...
for(my in seq(0.0,1,length=5)){
	for(mx in seq(0.0,1,length=5)){
